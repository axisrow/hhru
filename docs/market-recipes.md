...
## Аудит остаточных дублей

Нормализация — процесс, а не состояние: свободный текст владельцев резюме
порождает новые варианты написания, и правила фолда не закрывают их раз и
навсегда. После крупного сбора (или смены правил фолда) гоняйте аудит —
он находит пары ключей-близнецов (расстояние <=2) и группы, различающиеся
только цифрами:
