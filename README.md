...
- `--learn-questionnaires` — Предлагать шаблон для неотвеченных вопросов анкеты (требует подтверждения через `questionnaire learn`)
...
Просмотр и редактирование шаблонов ответов на вопросы анкет отклика.
