...
React `#418`/`#423` в консоли страницы профиля сами по себе не считаются
ошибкой команды: решающим является однозначное появление карточки языков после
ограниченного восстановления. При отсутствии маркера запись запрещена; подробный
контракт и критерии нового issue — в
[`docs/research/issue-567-profile-hydration.md`](docs/research/issue-567-profile-hydration.md).
