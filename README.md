...
- `--area` — Leaf-профессия из каталога визарда создания резюме; если фильтр каталога оставляет единственный лист, он принимается даже без точного совпадения (#920)
