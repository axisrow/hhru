...
- `--allow-unresolved-area, --allow-unresolved` — Разрешить черновик без профессии, если area не найдена в каталоге (синоним: --allow-unresolved)
