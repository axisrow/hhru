...
Предлагает языки через LLM, но не угадывает уровень CEFR. Боевой режим требует явного уровня NAME=CEFR и подтверждения. Раздел 'Языки' общий для всего профиля hh.ru: запись применяется ко всем резюме аккаунта, а не только к --resume.
...
- `--dry-run` — Показать план без записи на hh.ru
