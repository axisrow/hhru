...
# разделителей, гомоглифов) обязана поднять суффикс — иначе материализованные
# в БД ключи останутся по старым правилам навсегда, а отчёт будет считать по
# новым, и числа разъедутся молча.
BACKFILL_MARKER_KEY = "competitor_norm_backfill:v1"
