"""Классификатор «известная/неизвестная компания» как фактор скоринга (#74, Этап 2).

**classify_employer** — буст за Яндекс/Сбер/FAANG и пр. БЕЗ ML: O(1) lookup по
встроенному списку гигантов + эвристика по reviews_count из карточки поиска
hh.ru (#118: поле trusted для этого непригодно — им помечено ~98% карточек).
