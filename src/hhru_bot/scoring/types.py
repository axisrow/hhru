"""Общие типы пакета скоринга: результат, протокол провайдера, инфо о работодателе.

Лист графа импортов — ничего из пакета не тянет, поэтому любой вид скоринга
(вакансия #74, будущие resume-match/letter-match) может опираться на эти типы
без риска цикла.
"""
