...
# Список намеренно короткий — покрывает падежи/числа существительных и
# прилагательных, встречающиеся в названиях навыков и ролей, а не всю морфологию
# русского языка (это и есть Тир 0 из issue: без ML-рантайма и без зависимостей).
_RU_SUFFIXES = (
    "иями",
    "ями",
    "ами",
