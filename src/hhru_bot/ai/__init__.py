...
Нативный Responses API на ``openai`` SDK — вместо самодельного порта из
NousResearch/hermes-agent (#16/#96). ``openai`` — опциональная зависимость
(группа ``[ai]``); этот пакет импортируется без неё.
