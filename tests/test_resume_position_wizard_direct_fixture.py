...
Characterization of the "Уточните специальность" catalog modal редуцирована из
боевых дампов прогона #911 (battle2/clean, 2026-09-01): подтверждение открытости
по пяти наблюдаемым признакам, вложенный ``role=treeitem`` как единственный
носитель ``aria-selected``, вырождение неточного поиска в «Другое» (id 40).
"""
