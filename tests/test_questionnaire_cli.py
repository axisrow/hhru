...
def test_learn_rekeys_scans_recorded_under_the_config_slug(tmp_path, monkeypatch):
    ...
    """
    real_id = "00001111ff10f60ff30039ed1f6d5876645331"
...
def test_rekey_refuses_when_a_slug_collides_with_another_resumes_real_id(tmp_path, capsys):
    ...
    b_real = "00001111ff10f60ff30039ed1f6d5876645331"
...
def test_rekey_refuses_a_slug_matching_a_removed_resume_history_key(tmp_path, capsys):
    ...
    gone = "00001111ff10f60ff30039ed1f6d5876645331"
...
def test_rekey_still_runs_when_a_slug_equals_its_own_real_id(tmp_path):
    ...
    other_real = "00001111ff10f60ff30039ed1f6d5876645331"
    config = SimpleNamespace(
        resumes=[
